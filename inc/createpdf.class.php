...
// TODO ADDITIONAL FUTURE - save last print settings, per user, same code for PluginRgpdControllerInfo and PluginRgpdCreatePDF print execution
...
class PluginRgpdCreatePDF extends PluginRgpdCreatePDFBase {

   static $rightname = 'plugin_rgpd_createpdf';
   ...
   function getTabNameForItem(CommonGLPI $item, $withtemplate = 0) {
      ...
      switch ($item->getType()) {
         case PluginRgpdRecord::class :
            ...
            return self::createTabEntry(PluginRgpdCreatePDF::getTypeName(0), 0);
      }
   ...
   static function displayTabContentForItem(CommonGLPI $item, $tabnum = 1, $withtemplate = 0) {
      ...
      switch ($item->getType()) {
         case PluginRgpdRecord::class :
            self::showForm(PluginRgpdCreatePDF::REPORT_SINGLE_RECORD, $item->fields['id']);
            break;
      }
   ...
   protected function setEntityAndControllerInfo($entity_id) {
      ...
      $this->controller_info = PluginRgpdControllerInfo::getFirstControllerInfo($entity_id);
   ...
   static function showConfigFormElements($config = []) {
      ...
      echo "<td width='25%'>" . __("Show 'introduced in'", 'rgpd') . "</td>";
      echo "<td width='75%'>";
      ...
      echo "<tr class='tab_bg_1'>";
      echo "<td>" . __("Show comments", 'rgpd') . "</td>";
      echo "<td>";
      ...
      if (!isset($config['report_type'])) {
         $config['report_type'] = PluginRgpdCreatePDF::REPORT_SINGLE_RECORD;
      }

      if ($config['report_type'] != PluginRgpdCreatePDF::REPORT_SINGLE_RECORD) {
         echo "<tr class='tab_bg_1'>";
         echo "<td>" . __("Show deleted records", 'rgpd') . "</td>";
         echo "<td>";
         ...
         echo "<tr class='tab_bg_1'>";
         echo "<td>" . __("Show legal representative and DPO for each record", 'rgpd') . "</td>";
         echo "<td>";
      ...
      if (PluginRgpdCreatePDFBase::isGdprownerPluginActive()) {
         echo "<tr class='tab_bg_1'>";
         echo "<td>" . __("Show record owner information", 'rgpd') . "</td>";
         echo "<td>";
         ...
         echo "<tr class='tab_bg_1'>";
         echo "<td>" . __("Show assets owners", 'rgpd') . "</td>";
         echo "<td>";
      ...
      echo "<tr class='tab_bg_1'>";
      echo "<td>" . __("Show full personal data category list", 'rgpd') . "</td>";
      echo "<td>";
      ...
      echo "<tr class='tab_bg_1'>";
      echo "<td>" . __("Show expired contracts", 'rgpd') . "</td>";
      echo "<td>";
      ...
      echo "<tr class='tab_bg_1'>";
      echo "<td>" . __("Show contracts types header if empty list", 'rgpd') . "</td>";
      echo "<td>";
      ...
      echo "<tr class='tab_bg_1'>";
      echo "<td>" . __("Show 'is deleted' information in info header", 'rgpd') . "</td>";
      echo "<td>";
      ...
      echo "<tr class='tab_bg_1'>";
      echo "<td>" . __("Show print date/time", 'rgpd') . "</td>";
      echo "<td>";
      ...
      echo "<tr class='tab_bg_1'>";
      echo "<td>" . __("Page orientation", 'rgpd') . "</td>";
      echo "<td colspan='2'>";

      $orientation = [];
      $orientation['P'] = __("Portrait", 'rgpd');
      $orientation['L'] = __("Landscape", 'rgpd');
      ...
      echo "<tr class='tab_bg_1'>";
      echo "<td>" . __("Show record status in info header", 'rgpd') . "</td>";
      echo "<td>";
      ...
      echo "<table><tbody>";
      echo "<tr class='tab_bg_1'>";
      echo "<td width='75%'>" . __("Show legal representative", 'rgpd') . "</td>";
      echo "<td width='25%'>";
      ...
      echo "<tr class='tab_bg_1'>";
      echo "<td style='padding-left: 50px;'>" . __("Show title", 'rgpd') . "</td>";
      echo "<td>";
      ...
      echo "<tr class='tab_bg_1'>";
      echo "<td style='padding-left: 50px;'>" . __("Show address", 'rgpd') . "</td>";
      echo "<td>";
      ...
      echo "<tr class='tab_bg_1'>";
      echo "<td style='padding-left: 50px;'>" . __("Show phone", 'rgpd') . "</td>";
      echo "<td>";
      ...
      echo "<tr class='tab_bg_1'>";
      echo "<td style='padding-left: 50px;'>" . __("Show email", 'rgpd') . "</td>";
      echo "<td>";
      ...
      echo "<table><tbody>";
      echo "<tr class='tab_bg_1'>";
      echo "<td width='75%'>" . __("Show DPO", 'rgpd') . "</td>";
      echo "<td width='25%'>";
   ...
   static function showForm($report_type, $record_id = -1) {
      ...
      echo "<form name='form' method='GET' action=\"" . $CFG_GLPI['root_doc'] . "/plugins/rgpd/front/createpdf.php\" enctype='multipart/form-data'>";
      ...
      if ($report_type == PluginRgpdCreatePDF::REPORT_SINGLE_RECORD) {
         echo "<input type='hidden' name='record_id' value=\"" . $record_id . "\">";
      }
      echo "<input type='hidden' name='action' value=\"print\">";
      echo "<input type='submit' class='submit' name='createpdf' value='" . PluginRgpdCreatePDF::getTypeName(1) . "' />";
      Html::closeForm();
   }

   protected function prepareControllerInfo() {

      $controller_name = __("Controller name not set.", 'rgpd');
      ...
      $result = [
         'section' => "<h3>" . __("Controller", 'rgpd') . "</h3>",
         'value' => $info
      ];
   ...
   protected function preparePersonelInfo($person, $caption_not_set, $section_caption) {
      ...
      if ((isset($this->controller_info->fields['users_id_' . $person]) && !$this->controller_info->fields['users_id_' . $person]) ||
         ...
         if (empty($realname)) {
            $realname = __("N/A", 'rgpd');
         }
         $firstname = trim($user->fields['firstname']);
         if (empty($firstname)) {
            $firstname = __("N/A", 'rgpd');
         }
         ...
         if ($this->print_options['show_' . $person]['show_address']) {
            ...
            $address = isset($location->fields['address']) ? trim($location->fields['address']) : $address = __("N/A", 'rgpd');

            $postcode = isset($location->fields['postcode']) ? trim($location->fields['postcode']) : $postcode = __("N/A", 'rgpd');

            $town = isset($location->fields['town']) ? trim($location->fields['town']) : __("N/A", 'rgpd');
   ...
   protected function getRecordsForEntity($entity_id, $print_options = null, $include_recursive = false) {
      ...
      if ($include_recursive) {
         $include = '
                  (`glpi_plugin_rgpd_records`.`is_recursive` = 1 AND
                   `glpi_plugin_rgpd_records`.`entities_id` IN (' . implode(',', $entities) . ')
                  ) OR (
                   `glpi_plugin_rgpd_records`.`entities_id` = ' . $entity_id . '
                  )
         ';
      } else {
         $include = '`glpi_plugin_rgpd_records`.`entities_id` IN (' . implode(',', $entities) . ')';
      }
      $query = '
         SELECT
         ...
         FROM
            `glpi_plugin_rgpd_records` 
         LEFT JOIN
            `glpi_entities` ON (`glpi_plugin_rgpd_records`.`entities_id` = `glpi_entities`.`id`)
         WHERE
            ('
               . $include .
            ') AND (
               `glpi_plugin_rgpd_records`.`is_deleted` IN (' . implode(',', $include_deleted) . ')
            )
         ORDER BY
            `glpi_plugin_rgpd_records`.`name`';
   ...
   protected function getControllerName() {
      ...
      if (isset($this->controller_info->fields['controllername']) && !empty(trim($this->controller_info->fields['controllername']))) {
         ...
         return __("Controller information not set.", 'rgpd');
      }
   ...
   function generateReport($generator_options, $print_options) {
      ...
      switch ($generator_options['report_type']) {
         case PluginRgpdCreatePDF::REPORT_SINGLE_RECORD:
            ...
            break;
         case PluginRgpdCreatePDF::REPORT_FOR_ENTITY:
            $entities_id = $generator_options['entities_id'];
            $record = PluginRgpdCreatePDF::getRecordsForEntity($entities_id, $print_options, true);
            break;
         case PluginRgpdCreatePDF::REPORT_ALL:
            $entities_id = $_SESSION['glpiactive_entity'];
            $record = PluginRgpdCreatePDF::getRecordsForEntity($entities_id, $print_options);
            break;
      }
   ...
   protected function printHeader() {
      ...
      $header = __("GDPR Record of Processing Activities", 'rgpd');
      if ($this->print_options['show_print_date_time']) {
         $header .= ",   " . sprintf(__("print date/time: %1s", 'rgpd'), Html::convDateTime($_SESSION["glpi_currenttime"]));
      }
   ...
   protected function printActivitiesList($records) {
      ...
      if ($records) {
         ...
         $this->writeInternal(
            "<h2>" . __("List of processing activities for which entity deals with personal data", 'rgpd') . "</h2>", [
               'linebefore' => 8
            ]);

         if (!count($records)) {
            $this->writeInternal(__("There are no activities.", 'rgpd'), [
               'border' => 1,
               'linebefore' => 1
            ]);
         } else {
            $tbl = '<table border="1" cellpadding="3" cellspacing="0">' .
               '<thead><tr>' .
               '<th width="8%" style="background-color:#323232;color:#FFF;text-align:center;"><h3>' . __("No", 'rgpd') . '</h3></th>' .
               '<th width="' . $col_width . '%" style="background-color:#323232;color:#FFF;"><h3>' . __("Description of the activity", 'rgpd') . '</h3></th>';
            if ($display_introduced_in) {
               $tbl .= '<th width="50%" style="background-color:#323232;color:#FFF;"><h3>' . __("Introduced in", 'rgpd') . '</h3></th>';
            }
            $tbl .= '</tr></thead><tbody>';
   ...
   protected function printCoverPage($type, $records, $entities_id = -1) {
      ...
      switch ($type) {
         case PluginRgpdCreatePDF::REPORT_SINGLE_RECORD:
            $this->printPageTitle("<h1><small>" . __("GDPR Record of Processing Activity", 'rgpd') ."</small><br/>" . $records->fields['name'] . "</h1>");
            $this->printRecordStatusInfo($records);
            break;
         case PluginRgpdCreatePDF::REPORT_FOR_ENTITY:
            $entity = new Entity();
            $entity->getFromDB($entities_id);
            $this->printPageTitle("<h1><small>" . sprintf(__("GDPR Records of Processing Activity for entity:<br/>%1s", 'rgpd'), $entity->fields['name']) ."</small><br/>" . '' . "</h1>");
            break;
         case PluginRgpdCreatePDF::REPORT_ALL:
            $this->printPageTitle("<h1><small>" . __("GDPR Records of Processing Activity", 'rgpd') ."</small><br/>" . '' . "</h1>");
            break;
      }
      ...
      $datas[] = $this->preparePersonelInfo('representative', __("Legal representative not set.", 'rgpd'), __("Legal representative", 'rgpd'));
      $datas[] = $this->preparePersonelInfo('dpo', __("DPO not set.", 'rgpd'), __("Data Protection Officer", 'rgpd'));
   ...
   protected function printRecordStatusInfo(PluginRgpdRecord $record) {

      if ($this->print_options['show_is_deleted_header']) {
         if ($record->fields['is_deleted']) {
            $this->writeInternal(
               '<h3>' . __("The record is marked as DELETED", 'rgpd') . '</h3>', [
                  'fillcolor' => [80, 80, 80],
                  'fill' => 1,
      ...
      if ($this->print_options['show_status_in_header']) {
         ...
         $this->writeInternal(
            '<h3>' . sprintf(__("Record status: %s", 'rgpd'), $status) . '</h3>', [
   ...
   protected function addPageForRecord(PluginRgpdRecord $record, $reporty_type) {

      $this->pdf->addPage('P', 'A4');

      if ($reporty_type != PluginRgpdCreatePDF::REPORT_SINGLE_RECORD) {
         $this->printPageTitle("<h1><small>" . __("Sheet for GDPR Record of Processing Activities", 'rgpd') .":</small><br/>" . $record->fields['name'] . "</h1>");
      ...
      */
      ...
      $contracts = 0;
      $contracts += $this->printContracts($record, PluginRgpdRecord_Contract::CONTRACT_JOINTCONTROLLER, $contracts);
      $contracts += $this->printContracts($record, PluginRgpdRecord_Contract::CONTRACT_PROCESSOR, $contracts);
      $contracts += $this->printContracts($record, PluginRgpdRecord_Contract::CONTRACT_THIRDPARTY, $contracts);
      $contracts += $this->printContracts($record, PluginRgpdRecord_Contract::CONTRACT_INTERNAL, $contracts);
      $contracts += $this->printContracts($record, PluginRgpdRecord_Contract::CONTRACT_OTHER, $contracts);

      $this->printSoftware($record);

      $this->printSecurityMeasures($record, PluginRgpdSecurityMeasure::SECURITYMEASURE_TYPE_ORGANIZATION, true);
      $this->printSecurityMeasures($record, PluginRgpdSecurityMeasure::SECURITYMEASURE_TYPE_PHYSICAL);
      $this->printSecurityMeasures($record, PluginRgpdSecurityMeasure::SECURITYMEASURE_TYPE_IT);

   }

   protected function printRecordInformation(PluginRgpdRecord $record) {

      $this->writeInternal(
         '<h2>' . __("Processing Activity information", 'rgpd') . '</h2>', [
            'linebefore' => 1
         ]);

      $rows = [];
      $rows[] = [
         'section' => __("Name", 'rgpd'),
         'value' => $record->fields['name']
      ];
      $rows[] = [
         'section' => __("Purpose", 'rgpd'),
         'value' => $record->fields['content']
      ];
      if (!empty($record->fields['additional_info'])) {
         $rows[] = [
            'section' => __("Additional information", 'rgpd'),
      ...
      $storage_medium = PluginRgpdRecord::getAllStorageMediumArray();
      $rows[] = [
         'section' => __("Storage medium", 'rgpd'),
         'value' => $storage_medium[$record->fields['storage_medium']]
      ];
      $rows[] = [
         'section' => __("PIA required", 'rgpd'),
         'value' => Dropdown::getYesNo($record->fields['pia_required'])
      ];
      if ($record->fields['pia_required']) {
         $pia_status = PluginRgpdRecord::getAllPiaStatusArray();
         $rows[] = [
            'section' => __("PIA status", 'rgpd'),
      ...
      if (PluginRgpdCreatePDFBase::isGdprownerPluginActive()) {
         if ($this->print_options['show_record_owner']) {
            ...
            $owner_info = PluginGdprownerOwner::getOwnerInfo($record->fields['id'], PluginRgpdRecord::class);
            $owner = $owner_info['owner_type_name'] . ': ' . $owner_info['owner_name'];

            $rows[] = [
               'section' => __("Owner", 'rgpd'),
               'value' => $owner,
            ];
         }
      }
   ...
   protected function printLegalBasisActs(PluginRgpdRecord $record) {

      global $DB;

      $this->writeInternal(
         '<h2>' . PluginRgpdLegalBasisAct::getTypeName(1) . '</h2>', [
            'linebefore' => 1
         ]);

      $result = $DB->request([
         'FROM' => [PluginRgpdRecord_LegalBasisAct::getTable(), PluginRgpdLegalBasisAct::getTable()],
         'WHERE' => [
            PluginRgpdRecord_LegalBasisAct::getTable().'.`plugin_rgpd_records_id`' => $record->fields['id'],
            PluginRgpdRecord_LegalBasisAct::getTable().'.`plugin_rgpd_legalbasisacts_id`' => '`' . PluginRgpdLegalBasisAct::getTable().'`.`id`'
          ],
         'ORDER' => ['type'],
      ], "", true);
      ...
      if (!count($result)) {
         ...
         $tbl =
            ...
            '<thead><tr>' .
            '<th width="'. $cols_width[0] . '%" style="background-color:#AFAFAF;color:#FFF;"><h4>' . __("Name", 'rgpd') . '</h4></th>' .
            '<th width="'. $cols_width[1] . '%" style="background-color:#AFAFAF;color:#FFF;"><h4>' . __("Type", 'rgpd') . '</h4></th>';
         if ($this->print_options['show_inherited_from']) {
            $tbl .=
               '<th width="'. $cols_width[2] . '%" style="background-color:#AFAFAF;color:#FFF;"><h4>' . __("Introduced in", 'rgpd') . '</h4></th>';
         }
         $tbl .=
            '<th width="'. $cols_width[3] . '%" style="background-color:#AFAFAF;color:#FFF;"><h4>' . __("Content", 'rgpd') . '</h4></th>';
         if ($this->print_options['show_comments']) {
            $tbl .=
         ...
         $type = PluginRgpdLegalBasisAct::getAllTypesArray();
   ...
   protected function printDataSubjectsCategories(PluginRgpdRecord $record) {

      $data_subjects = (new PluginRgpdRecord_DataSubjectsCategory())
         ->find([PluginRgpdRecord::getForeignKeyField() => $record->fields['id']]);

      $this->writeInternal(
         '<h2>' . PluginRgpdRecord_DataSubjectsCategory::getTypeName(3) . '</h2>', [
            'linebefore' => 1
         ]);

      if (!count($data_subjects)) {

         $this->writeInternal(__("No data subjects category/ies assigned.", 'rgpd'), [
               'border' => 1,
               'linebefore' => 1
            ]);
         ...
         if ($this->print_options['show_inherited_from']) {
            $tbl .=
               '<th width="' . $cols_width[1] . '%" style="background-color:#AFAFAF;color:#FFF;"><h4>' . __("Introduced in", 'rgpd') . '</h4></th>';
         }
         if ($this->print_options['show_comments']) {
            $tbl .=
         ...
         foreach ($data_subjects as $item) {
            ...
            $dsc = new PluginRgpdDataSubjectsCategory();
            $dsc->getFromDB($item['plugin_rgpd_datasubjectscategories_id']);
   ...
   protected function printDataRetention(PluginRgpdRecord $record) {

      $retention = (new PluginRgpdRecord_Retention())
         ->find([PluginRgpdRecord::getForeignKeyField() => $record->fields['id']]);

      $this->writeInternal('<h2>' . PluginRgpdRecord_Retention::getTypeName(0) . '</h2>', [
            'linebefore' => 1
         ]);

      if (!count($retention)) {
         $this->writeInternal(__("Data retention not set.", 'rgpd'), [
               'border' => 1,
               'linebefore' => 1,
            ]);
      } else {
         foreach ($retention as $item) {
            ...
            $type = PluginRgpdRecord_Retention::getAllTypesArray();

            $tbl =
               '<table border="1" cellpadding="3" cellspacing="0">' .
               '<tbody><tr>' .
               '<td width="25%" style="background-color:#AFAFAF;color:#FFF;">' . __("Retention regulated by", 'rgpd') . '</td>' .
            ...
            switch ($item['type']) {
               case PluginRgpdRecord_Retention::RETENTION_TYPE_CONTRACT:
                  ...
                  if (!$item['contract_until_is_valid']) {
                     $scale = PluginRgpdRecord_Retention::getRetentionPeriodScales($item['contract_retention_scale'], $item['contract_retention_value']);
                     $period = $item['contract_retention_value'] . ' ' . $scale;

                     if ($item['contract_after_end_of']) {
                        $period = sprintf(__("Data retention: %1\$s after contract is terminated", 'rgpd'), $period);
                     }
                  } else {
                     $period = __("Until contract is valid", 'rgpd');
                  }
                  ...
                  $s_names = PluginRgpdRecord_Contract::getSuppliersNamesNoIds($item['contracts_id'], ', ');
                  if (empty($s_names)) {
                     $s_names = __("N/A", 'rgpd');
                  }

                  $c_name = trim(sprintf(__("Contract name/number: %1\$s %2\$s", 'rgpd'), $name, $num));
                  $s_names = trim($s_names);
                  $begin_date = trim(sprintf(__("Begin date: %1\$s", 'rgpd'), Html::convDate($contract->fields['begin_date'])));
                  $comment = trim(sprintf(__("Comment: %1\$s", 'rgpd'), $contract->fields['comment']));
                  $period = trim($period);
                  $comment = trim($comment);

                  $tbl .=
                     '</tr><tr>' .
                     '<td width="25%" style="background-color:#AFAFAF;color:#FFF;">' . __("Contract info", 'rgpd') . '</td>' .
                     '<td width="75%">' .
                     '<ul>' .
                     '<li><strong>' . $c_name . '</strong></li>' .
                     '<li>' . __("Supplier", 'rgpd') . ': ' . $s_names . '</li>' .
                     '<li>' . $begin_date . '</li>' .
                     '<li>' . $period . '</li>';
                  if ($this->print_options['show_comments']) {
                     $tbl .=
               ...
               case PluginRgpdRecord_Retention::RETENTION_TYPE_LEGALBASISACT:
                  ...
                  $legal_basis = new PluginRgpdLegalBasisAct();
                  $legal_basis->getFromDB($item['plugin_rgpd_legalbasisacts_id']);
                  ...
                  $tbl .=
                     ...
                     '<td width="75%">' . sprintf(__("Name: %1\$s", 'rgpd'), $name) . '</td>';
               ...
               case PluginRgpdRecord_Retention::RETENTION_TYPE_NONE:
                  $tbl .=
                     '</tr><tr>' .
                     '<td width="25%" style="background-color:#AFAFAF;color:#FFF;">' . '' . '</td>' .
                     '<td width="75%">' . __("Data retention is not required", 'rgpd') . '</td>';
                  break;
            ...
            $tbl .=
               '</tr><tr>' .
               '<td width="25%" style="background-color:#AFAFAF;color:#FFF;">' . __("Additional information", 'rgpd') . '</td>' .
   ...
   protected function printContracts(PluginRgpdRecord $record, $type, $print_header) {

      $get_expired = $this->print_options['show_expired_contracts'];
      $iterator = PluginRgpdRecord_Contract::getContracts($record, $type, $get_expired);
      ...
      if (!$print_header) {
         $this->writeInternal('<h2>' . __("Contracts related to processing activity", 'rgpd') . '</h2>', [
            'linebefore' => 1
         ]);
      }

      $subtitle = PluginRgpdRecord_Contract::getContractTypeStr($type);
      ...
      if (!$number) {
         $this->writeInternal(__("None.", 'rgpd'), [
            'border' => 1,
            'linebefore' => 1
         ]);
      } else {
         ...
         $tbl = '<table border="1" cellpadding="3" cellspacing="0">
            ...
            <th width="' . $cols_width[3] . '%" style="background-color:#AFAFAF;color:#FFF;"><h4>' . __("Contract info", 'rgpd') . '</h4></th>
            <th width="' . $cols_width[4] . '%" style="background-color:#AFAFAF;color:#FFF;"><h4>' . __("Expiry", 'rgpd') . '</h4></th>';
         if ($this->print_options['show_comments']) {
            $tbl .=
         ...
         while ($data = $iterator->next()) {
            ...
            if ($data['contracts_begin_date']) {
               $contract_info .= '<br>' . __("Begin date:", 'rgpd') . '' . $data['contracts_begin_date'];
            }
   ...
   protected function printPersonalDataCategories(PluginRgpdRecord $record) {

      $this->writeInternal(
         '<h2>' . PluginRgpdRecord_PersonalDataCategory::getTypeName(1) . '</h2>', [
            'linebefore' => 1
         ]);

      $pdc_list = (new PluginRgpdRecord_PersonalDataCategory())
         ->find([PluginRgpdRecord::getForeignKeyField() => $record->fields['id']]);

      if (!count($pdc_list)) {
         $this->writeInternal(__("None assigned.", 'rgpd'), [
            'border' => 1,
            'linebefore' => 1
         ]);
      } else {
         ...
         $tbl .=
            '<thead><tr>' .
            '<th width="' . $cols_width[0]. '%" style="background-color:#AFAFAF;color:#FFF;"><h4>' . __("Complete name", 'rgpd') . '</h4></th>' .
            '<th width="' . $cols_width[1]. '%" style="background-color:#AFAFAF;color:#FFF;"><h4>' . __("Special category", 'rgpd') . '</h4></th>';
         if ($this->print_options['show_inherited_from']) {
            $tbl .=
               '<th width="' . $cols_width[2] . '%" style="background-color:#AFAFAF;color:#FFF;"><h4>' . __("Introduced in", 'rgpd') . '</h4></th>';
         }
         ...
         foreach ($pdc_list as $pdc_item) {
            ...
            if ($this->print_options['show_full_personaldatacategorylist']) {
               $sons = getSonsOf(PluginRgpdPersonalDataCategory::getTable(), $pdc_item['plugin_rgpd_personaldatacategories_id']);
            } else {
               $sons = [];
               $sons[] = $pdc_item['plugin_rgpd_personaldatacategories_id'];
            }
   ...
   protected function printSoftware(PluginRgpdRecord $record) {

      global $DB;

      if (($record->fields['storage_medium'] == PluginRgpdRecord::STORAGE_MEDIUM_PAPER_ONLY)
         || ($record->fields['storage_medium'] == PluginRgpdRecord::STORAGE_MEDIUM_UNDEFINED)) {
         return;
      }
      ...
      $query = '
         ...
         LEFT JOIN
            glpi_softwares
             ON (glpi_plugin_rgpd_records_softwares.softwares_id = glpi_softwares.id)
         LEFT JOIN
            glpi_manufacturers
         ...
         WHERE
            glpi_plugin_rgpd_records_softwares.plugin_rgpd_records_id = ' . $record->fields['id'] . ' AND
             glpi_softwares.is_deleted = 0
      ';
      $software_list = $DB->request($query);

      $this->writeInternal('<h2>' . __("Software", 'rgpd') . '</h2>', [
         'linebefore' => 1
         ]);

      if (!count($software_list)) {
         $this->writeInternal(__("Software not assigned.", 'rgpd'), ['border' => 1]);
      } else {
         if ($this->print_options['show_inherited_from']) {
         ...
         $tbl =
            ...
            '<th width="' . $cols_width[0] . '%" style="background-color:#AFAFAF;color:#FFF;"><h4>' . __("Name", 'rgpd') . '</h4></th>' .
            '<th width="' . $cols_width[1] . '%" style="background-color:#AFAFAF;color:#FFF;"><h4>' . __("Type", 'rgpd') . '</h4></th>' .
            '<th width="' . $cols_width[2] . '%" style="background-color:#AFAFAF;color:#FFF;"><h4>' . __("Publisher", 'rgpd') . '</h4></th>';

         if ($this->print_options['show_inherited_from']) {
            $tbl .=
               '<th width="' . $cols_width[3] . '%" style="background-color:#AFAFAF;color:#FFF;"><h4>' . __("Introduced in", 'rgpd') . '</h4></th>';
         }
         if ($this->print_options['show_assets_owners']) {
            $tbl .=
               '<th width="' . $cols_width[4] . '%" style="background-color:#AFAFAF;color:#FFF;"><h4>' . __("Owner", 'rgpd') . '</h4></th>';
         }
         if ($this->print_options['show_comments']) {
            $tbl .=
               '<th width="' . $cols_width[5] . '%" style="background-color:#AFAFAF;color:#FFF;"><h4>' . __("Comment") . '</h4></th>';
   ...
   protected function printSecurityMeasures(PluginRgpdRecord $record, $type, $header = false) {

      global $DB;

      $this->insertNewPageIfBottomSpaceLeft(30);

      $types = PluginRgpdSecurityMeasure::getAllTypesArray();
      $sub_caption = $types[$type];

      if ($header) {
         $this->writeInternal(
            '<h2>' . PluginRgpdSecurityMeasure::getTypeName(2) . '</h2>', [
               'linebefore' => 1
            ]);
      }
      ...
      $result = $DB->request([
         'FROM' => [PluginRgpdRecord_SecurityMeasure::getTable(), PluginRgpdSecurityMeasure::getTable()],
            'FKEY' => [
               PluginRgpdRecord_SecurityMeasure::getTable() => 'plugin_rgpd_securitymeasures_id',
               PluginRgpdSecurityMeasure::getTable() => 'id'
            ],
            'ORDER' => ['name'],
            'AND' => [
               'plugin_rgpd_records_id' => $record->fields['id'],
               'type' => $type
            ]
      ]);
